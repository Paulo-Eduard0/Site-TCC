...
export default function Filosofia() {
  ...
  const handleVoltar = () => {
    // AJUSTE AQUI: Substitua '/tela-anterior' pelo caminho da tela específica
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      ...
      <View style={styles.container}>
        ...
        <View>
          <Text style={styles.brain}>Filosofia</Text>
        </View>

        <View style={styles.buttonsContainer}>
          <View style={styles.buttonRow}>
 
           <Link href="../desigualdadeFilosof" asChild>
            <TouchableOpacity style={styles.button}>
              <Text style={styles.buttonText}>Desigualdade social</Text>
            </TouchableOpacity>
           </Link> 
 
           <Link href="../educaçãoFilosof" asChild>
            <TouchableOpacity style={styles.button}>
          ...
          <View style={styles.buttonRow}>
           ...
           <Link href="../violenciaFilosof" asChild>
            <TouchableOpacity style={styles.button}>
              <Text style={styles.buttonText}>Violência contra a Mulher</Text>
            </TouchableOpacity>
           </Link> 
         
           <Link href="../ambienteFilosof" asChild>
            <TouchableOpacity style={styles.button}>
