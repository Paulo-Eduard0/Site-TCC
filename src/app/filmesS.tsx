...
export default function FilmesSeries() {
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      ...
      <View style={styles.container}>
        ...
        <View>
          <Text style={styles.brain}>Filmes/Série</Text>
        </View>
        ...
        <View style={styles.buttonsContainer}>
          <View style={styles.buttonRow}>
           ...
           <Link href="../distopiaF" asChild>
            <TouchableOpacity style={styles.button}>
              <Text style={styles.buttonText}>Distopias e Crítica Social</Text>
            </TouchableOpacity>
           </Link> 
 
           <Link href="../raciaisF" asChild>
            <TouchableOpacity style={styles.button}>
              <Text style={styles.buttonText}>Questões Raciais e Sociais</Text>
            </TouchableOpacity>
           </Link> 
          ...
          <View style={styles.buttonRow}>
           ...
           <Link href="../ambienteF" asChild>
            <TouchableOpacity style={styles.button}>
              <Text style={styles.buttonText}>Meio Ambiente</Text>
            </TouchableOpacity>
           </Link> 

           <Link href="../saudeF" asChild>
            <TouchableOpacity style={styles.button}>
          ...
          <View style={styles.buttonRow}>
           ...
           <Link href="../feminismoF" asChild>
            <TouchableOpacity style={styles.button}>
              <Text style={styles.buttonText}>Gênero e Feminismo</Text>
            </TouchableOpacity>
           </Link> 

           <Link href="../educaçãoF" asChild>
            <TouchableOpacity style={styles.button}>
