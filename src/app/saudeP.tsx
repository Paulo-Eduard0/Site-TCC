...
export default function SaudePodcasts() {
      ...
      <View style={styles.container}>
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.cardText}>
            <Text style={styles.cardTitle}>Dragões de Garagem:</Text> 
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.cardText}>
            <Text style={styles.cardTitle}> SciTalk:</Text> 
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.cardText}>
            <Text style={styles.cardTitle}>Fronteiras da Ciência (UFRGS):</Text> 
              Temas complexos explicados.
          </Text>
        </View>
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.cardText}>
            <Text style={styles.cardTitle}>PODTES</Text> 
               Saúde pública e SUS.
          </Text>
        </View>
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.cardText}>
            <Text style={styles.cardTitle}>Oxigênio (USP):</Text> 
