  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      ...
      <View style={styles.container}>
        ...
        <View>
          <Text style={styles.brain}>História</Text>
        </View>
        ...
        <View style={styles.buttonsContainer}>
          ...
          <Link href="../sociaisH" asChild>
           ...
           <Link href="../formacao" asChild>
            <TouchableOpacity style={styles.button}>
              <Text style={styles.buttonText}>Formação dos Estados Nacionais</Text>
            </TouchableOpacity>
           </Link>
          ...
          <Link href="../crises" asChild>
            <TouchableOpacity style={styles.button}>
              <Text style={styles.buttonText}>Crises Econômicas e Transformações</Text>
            </TouchableOpacity>
          </Link>  
          
          <Link href="../cultura" asChild>
            <TouchableOpacity style={styles.button}>
              <Text style={styles.buttonText}>Cultura e Representação</Text>
            </TouchableOpacity>
          </Link>  
