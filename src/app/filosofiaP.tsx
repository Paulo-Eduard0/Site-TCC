      ...
      <View style={styles.container}>
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.cardText}>
            <Text style={styles.cardTitle}> Filosofia Pop (UNESP):</Text> 
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.cardText}>
            <Text style={styles.cardTitle}>Via Cast:</Text> 
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.cardText}>
            <Text style={styles.cardTitle}>Hipocrisia:</Text> 
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.cardText}>
            <Text style={styles.cardTitle}>Peteca na Mão:</Text> 
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.cardText}>
            <Text style={styles.cardTitle}>Braincast:</Text> 
