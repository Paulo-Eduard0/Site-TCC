      ...
      <View style={styles.container}>
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.cardText}>
            <Text style={styles.cardTitle}>Salvo Melhor Juízo:</Text> 
            Direito e sociedade.
          </Text>
        </View>
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.cardText}>
            <Text style={styles.cardTitle}> Anticast:</Text> 
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.cardText}>
            <Text style={styles.cardTitle}>Escriba Café:</Text> 
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.cardText}>
            <Text style={styles.cardTitle}> Durma com essa (Nexo)</Text> 
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.cardText}>
            <Text style={styles.cardTitle}>História FM:</Text> 
