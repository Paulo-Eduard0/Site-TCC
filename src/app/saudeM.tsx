...
export default function SaudeMentalMusica() {
      ...
      <View style={styles.container}>
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.cardText}>
            <Text style={styles.cardTitle}>"Pais e Filhos" (Legião Urbana):</Text> 
           Conflitos geracionais e familiares.
          </Text>
        </View>
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.cardText}>
            <Text style={styles.cardTitle}>"Farol das Estrelas" (O Rappa):</Text> 
             Busca por esperança na escuridão.
          </Text>
        </View>
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.cardText}>
            <Text style={styles.cardTitle}>"Vou Deixar" (Skank):</Text> 
             Sobre término e superação
          </Text>
        </View>
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.cardText}>
            <Text style={styles.cardTitle}>"Trem-Bala" (Ana Vilela):</Text> 
