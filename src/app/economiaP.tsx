...
export default function EconomiaPodcasts() {
      ...
      <View style={styles.container}>
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.cardText}>
            <Text style={styles.cardTitle}>Mamilos:</Text> 
            Debate profundo sobre temas polêmicos.
          </Text>
        </View>
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.cardText}>
            <Text style={styles.cardTitle}>Market Makers:</Text> 
             Economia e negócios.
          </Text>
        </View>
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.cardText}>
            <Text style={styles.cardTitle}>Como Vender Sua Ideia:</Text> 
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.cardText}>
            <Text style={styles.cardTitle}>Carreira sem Fronteiras:</Text> 
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.cardText}>
            <Text style={styles.cardTitle}>NerdCash :</Text> 
             Educação financeira.
          </Text>
        </View>
